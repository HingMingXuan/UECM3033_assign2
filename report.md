...
Finally, a new lower resolution image plotted. The n can be change where lower n for lower resolution image while higher n for higher resolution picture. 
